...
@section('content')
    <div class="Product_List">
        <div class="pf_title m-3 mx-lg-6">
            <a href="{{url('retailer/productList')}}">
                <h4 class="active">Product List</h4>
            </a>
            <a href="{{url('retailer/productCategory')}}">
                    ...
                    <div class="col-12 col-md-6 col-xl-3 col-xxl-3">
                        <div class="d-flex justify-content-end move_delete">
                            <div class="btn_black py-2  px-3 px-lg-4 d-flex align-items-center Move_btn message" data-toggle="modal"  data-target-id="enquiry" data-target="#move_modal_id" >
                                <img src="{{asset('assets/img/icons/Path_280.png')}}" class="img-fluid mx-1" alt="">
                                <span>Move(3)</span>
                            </div>
                            ...
                            <div class=" mb-3 mx-md-3 mx-lg-5 ">
                                ...
                                <div class="row g-3">
                                    <div class=" col-6 col-md-4 col-xxl-2">
                                        <div class=" bg-white px-3 py-4 product">
                                            <div class="product_img text-center">
                                                <img src="{{asset('assets/img/Product/Group_296.png')}}" class="img-fluid" alt="product image">
                                            </div>
                                    ...
                                    <div class=" col-6 col-md-4 col-xxl-2">
                                        <div class=" bg-white px-3 py-4 product">
                                            <div class="product_img text-center">
                                                <img src="{{asset('assets/img/Product/Group+298.png')}}" class="img-fluid" alt="product image">
                                            </div>
                                            <div class="product_name mt-3">
                                                <h5 class="mb-0 text-center">Bumpers & Components</h5>
                                            </div>
                                    ...
                                    <div class=" col-6 col-md-4 col-xxl-2">
                                        <div class=" bg-white px-3 py-4 product">
                                            <div class="product_img text-center">
                                                <img src="{{asset('assets/img/Product/Group_299.png')}}" class="img-fluid" alt="product image">
                                            </div>
                                            <div class="product_name mt-3">
                                                <h5 class="mb-0 text-center">Bumpers & Components</h5>
                                            </div>
                                    ...
                                    <div class=" col-6 col-md-4 col-xxl-2">
                                        <div class=" bg-white px-3 py-4 product">
                                            <div class="product_img text-center">
                                                <img src="{{asset('assets/img/Product/Group_302.png')}}" class="img-fluid" alt="product image">
                                            </div>
                                            <div class="product_name mt-3">
                                                <h5 class="mb-0 text-center">Bumpers & Components</h5>
                                            </div>
                                    ...
                                    <div class=" col-6 col-md-4 col-xxl-2">
                                        <div class=" bg-white px-3 py-4 product">
                                            <div class="product_img text-center">
                                                <img src="{{asset('assets/img/Product/Group_303.png')}}" class="img-fluid" alt="product image">
                                            </div>
                                            <div class="product_name mt-3">
                                                <h5 class="mb-0 text-center">Bumpers & Components</h5>
                                            </div>
                                    ...
                                    <div class=" col-6 col-md-4 col-xxl-2">
                                        <div class=" bg-white px-3 py-4 product">
                                            <div class="product_img text-center">
                                                <img src="{{asset('assets/img/Product/Group_306.png')}}" class="img-fluid" alt="product image">
                                            </div>
                                            <div class="product_name mt-3">
                                                <h5 class="mb-0 text-center">Bumpers & Components</h5>
                                            </div>
                                    ...
                                    <div class=" col-6 col-md-4 col-xxl-2">
                                        <div class=" bg-white px-3 py-4 product">
                                            <div class="product_img text-center">
                                                <img src="{{asset('assets/img/Product/Group_316.png')}}" class="img-fluid" alt="product image">
                                            </div>
                                            <div class="product_name mt-3">
                                                <h5 class="mb-0 text-center">Bumpers & Components</h5>
                                            </div>
                                    ...
                                    <div class=" col-6 col-md-4 col-xxl-2">
                                        <div class=" bg-white px-3 py-4 product">
                                            <div class="product_img text-center">
                                                <img src="{{asset('assets/img/Product/Group_317.png')}}" class="img-fluid" alt="product image">
                                            </div>
                                            <div class="product_name mt-3">
                                                <h5 class="mb-0 text-center">Bumpers & Components</h5>
                                            </div>
                                    ...
                                    <div class=" col-6 col-md-4 col-xxl-2">
                                        <div class=" bg-white px-3 py-4 product">
                                            <div class="product_img text-center">
                                                <img src="{{asset('assets/img/Product/Group_308.png')}}" class="img-fluid" alt="product image">
                                            </div>
                                            <div class="product_name mt-3">
                                                <h5 class="mb-0 text-center">Bumpers & Components</h5>
                                            </div>
                                    ...
                                    <div class=" col-6 col-md-4 col-xxl-2">
                                        <div class=" bg-white px-3 py-4 product">
                                            <div class="product_img text-center">
                                                <img src="{{asset('assets/img/Product/Group_310.png')}}" class="img-fluid" alt="product image">
                                            </div>
                                            <div class="product_name mt-3">
                                                <h5 class="mb-0 text-center">Bumpers & Components</h5>
                                            </div>
                                    ...
                                    <div class=" col-6 col-md-4 col-xxl-2">
                                        <div class=" bg-white px-3 py-4 product">
                                            <div class="product_img text-center">
                                                <img src="{{asset('assets/img/Product/Group_312.png')}}" class="img-fluid" alt="product image">
                                            </div>
                                            <div class="product_name mt-3">
                                                <h5 class="mb-0 text-center">Bumpers & Components</h5>
                                            </div>
                                    ...
                                    <div class=" col-6 col-md-4 col-xxl-2">
                                        <div class=" bg-white px-3 py-4 product">
                                            <div class="product_img text-center">
                                                <img src="{{asset('assets/img/Product/Group_314.png')}}" class="img-fluid" alt="product image">
                                            </div>
                                            <div class="product_name mt-3">
                                                <h5 class="mb-0 text-center">Bumpers & Components</h5>
                                            </div>
