...
@section('content')
    <div class="Revenue_Management">
        <div class="pf_title d-flex m-3 mx-lg-5">
            <a href="Revenue_Management.html" class="first">
                <h5 class="active">All Voucher(1,827)</h5>
            </a>
            <a href="Withdraw_History.html" class="first">
                    ...
                    <div class="table px-3">
                        <div class="row">
                            <div class="d-block d-xl-none col-12">
                                <a href="{{url('voucher/create')}}" class="text-dark">
                                        ...
                                        <div class="col-12 col-xl-4">
                                            <div class="row gy-3 gy-xl-0">
                                                ...
                                                <div class="col-12 col-xl-2">
                                                    <div class="d-flex">
                                                        <a class="message">
                                                            <img class="img-fluid" src="{{url('assets/img/icons/Group_1104.png')}}"
                                                                 alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-xl-3 col-xxl-4">
                                                    <div
                                                        ...
                                                        <a href=""> <img class=" img-fluid"
                                                                         src="{{url('assets/img/icons/Group_90.png')}}" alt=""></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row gy-3 gy-xl-0">
                                                ...
                                                <div class="col-12 col-xl-3 col-xxl-4">
                                                    <div
                                                        ...
                                                        <a href="">
                                                            <img class=" img-fluid"
                                                                 src="{{url('assets/img/icons/Group_1134.png')}}" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                        ...
                        <div class="modal_header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-3 col-lg-1">
                                    <p class=" text-end">
                                        <a href="" class=" img-fluid "><img src="{{url('assets/img/icons/Group_87.png')}}" alt=""></a>
                                    </p>
                                </div>
                            </div>
                        </div>
