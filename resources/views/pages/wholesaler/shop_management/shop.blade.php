        ...
        <div class="row">
            <div class="col-12 col-lg-10 col-xxl-9">
                <div class="d-flex justify-content-between mb-3 Eidit_bar">
                    ...
                    <a href="{{url('wholesaler/shop/create')}}">
                        <img class=" img-fluid"
                             src="{{asset('assets/img/icons/Group_637.png')}}" alt="">
                    </a>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <img class=" img-fluid" src="{{asset('assets/img/Group_632.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-xl-4">
                        <div class="col-12 col-md-4 col-xxl-3">
                            <div class="logo mb-2 mb-md-0 d-md-flex justify-content-md-center">
                                <img src="{{asset('assets/img/Group_635.png')}}" alt="">
                            </div>
                        </div>
